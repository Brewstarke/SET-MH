SET_Plot_overlay3 <- function(SET_Type = 'Rod SET', highlightSite = NULL, title= "ADD A TITLE")
{
	require(ggplot2)
	require(ggthemes)
	require(plyr)
...
SET_Plot_overlay3(SET_Type = "Rod SET", highlightSite = c("North Greensedge - West Hempstead", "Lawrence Marsh"), title = "Marsh elevation changes across LI")
